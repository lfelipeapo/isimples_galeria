...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "fm_atua_dados")) {
  ...
  $updateGoTo = "albuns/criar_albuns.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
.style11 {font-family: Geneva, Arial, Helvetica, sans-serif; font-size: 10px; }
-->
</style>
</head>
    ...
    <td colspan="2"><form action="<?php echo $editFormAction; ?>" id="fm_atua_dados" name="fm_atua_dados" method="POST">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td width="10">&nbsp;</td>
          <td><input name="Senha" type="text" id="Senha" readonly="readonly" value="<?php echo $row_rsAdmin['Senha']; ?>" /></td>
        </tr>
        <tr>
          <td width="140" align="right"><span class="style6"></span></td>
          <td width="10">&nbsp;</td>
          <td><input type="submit" name="btn_editarfoto" id="btn_editarfoto" value="Atualizar Dados" />
            <span class="style5 style8 style10"><span class="style11">Dados atualizados com sucesso!</span></span></td>
        </tr>
      </table>
