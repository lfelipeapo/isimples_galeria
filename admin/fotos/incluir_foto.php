...
if ((isset($HTTP_POST_VARS["MM_insert"])) && ($HTTP_POST_VARS["MM_insert"] == "fm_criaalbum")) {
  $insertSQL = sprintf("INSERT INTO Fotos (IDAlbum, Foto, `Desc`) VALUES (%s, %s, %s)",
...
<table width="580" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <?php if ($totalRows_rsFotos == 0) { // Show if recordset empty ?>
    <tr>
      <td>&nbsp;</td>
      <td colspan="2"><span class="style7">Este Álbum ainda não possui fotos.</span></td>
      <td>&nbsp;</td>
    </tr>
  ...
  <?php if ($totalRows_rsFotos > 0) { // Show if recordset not empty ?>
    <tr>
      <td>&nbsp;</td>
      <td colspan="2" class="style7">Inclua + Fotos no Álbum <span class="style8"><?php echo $row_rsAlbuns['Desc']; ?></span></td>
      <td>&nbsp;</td>
    </tr>
  ...
  <tr>
    <td width="9">&nbsp;</td>
    <td colspan="2" align="center"><form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="fm_criaalbum" id="fm_criaalbum" onSubmit="checkFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',true,2000,'','','','','','');showProgressWindow('fileCopyProgress.htm',300,100);return document.MM_returnValue">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td><input name="Foto" type="file" id="Foto" onChange="checkOneFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',true,2000,'','','','','','')" size="40" />
            <input name="IDAlbum" type="hidden" id="IDAlbum" value="<?php echo $row_rsAlbuns['IDAlbum']; ?>" /></td>
        </tr>
        <tr>
          <td width="140" align="right"><span class="style6"></span></td>
          <td width="10">&nbsp;</td>
          <td><input type="submit" name="btn_adicionarfoto" id="btn_adicionarfoto" value="Adicionar Foto" /></td>
        </tr>
      </table>
  ...
  <tr>
    <td width="9">&nbsp;</td>
    <td colspan="2" align="center" class="style7">Fotos deste Álbum <span class="style5">(<?php echo $totalRows_rsFotos ?> Fotos)</span></td>
    <td width="10">&nbsp;</td>
  </tr>
  <tr>
    <td width="9">&nbsp;</td>
  ...
  <?php do { ?>
    <tr>
      ...
      <td width="171" align="center" class="style5"><?php if ($totalRows_rsFotos > 0) { // Show if recordset not empty ?>
          <a href="editar_foto.php?IDAlbum=<?php echo $row_rsFotos['IDAlbum']; ?>&amp;IDFoto=<?php echo $row_rsFotos['IDFoto']; ?>">Editar</a> / <a href="excluir_foto.php?IDAlbum=<?php echo $row_rsFotos['IDAlbum']; ?>&amp;IDFoto=<?php echo $row_rsFotos['IDFoto']; ?>">Excluir</a>
          <?php } // Show if recordset not empty ?>
</td>
      <td>&nbsp;</td>
    </tr>
